...
As práticas abaixo são compromissos para o desenvolvimento do produto. Sua previsão no documento não comprova execução; a aplicação será registrada em cada ciclo.
